...
if (!localstorageUserdata) {
  SW_userData.wallpaper = `https://random.imagecdn.app/${window.screen.width}/${window.screen.height}`;
}
...
function randomWallpaper() {
  ...
  return `https://random.imagecdn.app/${window.screen.width}/${window.screen.height}`
