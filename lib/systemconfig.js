...
async function randomWallpaper() {
  let curatedWallpaperList = [ 
    "https://wallpapercave.com/download/amsterdam-netherlands-wallpapers-wp12496040",
    "https://wallpapercave.com/download/rainy-japan-wallpapers-wp12496139",
    "https://wallpapercave.com/download/ukraine-wallpapers-wp1961619",
    "https://wallpapercave.com/download/anime-japanese-city-night-wallpapers-wp12105359",
    "https://wallpapercave.com/download/anime-japanese-city-night-wallpapers-wp12105367",
    "https://images.pexels.com/photos/1526410/pexels-photo-1526410.jpeg",
    "https://images.pexels.com/photos/1200854/pexels-photo-1200854.jpeg"
  ]
  ...
  const randomselect = swdeutils.randomizerange(0, curatedWallpaperList.length - 1);
  const image = curatedWallpaperList[randomselect];

  return image
}

let SW_apps = {};
if(swdeutils.saveload("load", { item: "SW_apps" })) {
  SW_apps = swdeutils.saveload("load", { item: "SW_apps" } );
} else {
  SW_apps  = [
    { 
      name: "MBrowser", 
      app: "browser", 
      desc: "An internet browser, some sites may not work because of crossorigin policies.",
    ...
    { 
      name: "Text Editor", 
      app: "texteditor", 
      icon: "./img/icons/system/icon-texteditor.png", 
    ...
    { 
      name: "Code Editor", 
      app: "code_editor", 
      icon: "./img/icons/system/icon-codeeditor.png", 
      path: "./lib/apps/code_editor/code_editor.js",
      run: "swdeapp_code_editor",
      apptype: "local",
    },
    { 
    ...
    { 
      name: "Prismarine Web Client - Minecraft Online", 
      app: "webmc", 
      icon: "https://d60kl4rmeuiuq.cloudfront.net/favicon.png", 
      path: "https://d60kl4rmeuiuq.cloudfront.net/",
      apptype: "externalweb",
    },
    { 
      name: "Tic80 - Fantasy Computer", 
      app: "tic80", 
      icon: "https://tic80.com/favicon.ico", 
      path: "https://tic80.com/",
      apptype: "externalweb",
    },
    { 
      name: "Click Jogos", 
    ...
    { 
      name: "Radio Online - Hunter", 
      app: "Radio Online Hunter", 
      icon: "https://hunter.fm/favicon.ico", 
      path: "https://hunter.fm/",
      apptype: "externalweb",
    },
  ];
}

swdeutils.saveload("save", { item: "SW_apps", data: SW_apps });
renderUI()