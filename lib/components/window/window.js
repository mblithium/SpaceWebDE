function createWindow (appinfo, path) {
    ...
    function runApp(appinfo) {
        ...
        if (appinfo.apptype == "local") {
            const libPath = "./lib";
            swdehandlescr("load", appinfo.path, appinfo.app);
    ...
    // swdewindow.querySelector(".swde-window-content").innerHTML = swdeApp_terminal();
    ...
    document.body.querySelector("#desktop").appendChild(swdewindow);
